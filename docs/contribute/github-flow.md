<!-- Space: Projects -->
<!-- Parent: ZshTmux -->
<!-- Title: Contributing GithubFlow ZshTmux -->
<!-- Label: ZshTmux -->
<!-- Label: Project -->
<!-- Label: Contributing -->
<!-- Label: GithubFlow -->
...
To contribute to zsh-tmux project on [GitHub](https://github.com/hadenlabs/zsh-tmux), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/zsh-tmux/pulls).
...
To follow the instructions in this guide and start contributing to zsh-tmux project on GitHub:
...
```bash
git remote add upstream  https://github.com/hadenlabs/zsh-tmux.git
```

Now your **upstream** points to **hadenlabs/zsh-tmux**.
...
git fetch upstream # assuming upstream is hadenlabs/zsh-tmux
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/zsh-tmux/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
